...
HD_PWD='/home/user/cours/PR209_MP3/Projects/Partie_2/Partie_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Partie2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_Partie2.tcl -notrace
