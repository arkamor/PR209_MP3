...
HD_PWD='/home/user/cours/PR209_MP3/Projects/Partie_3/Partie_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Partie3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_Partie3.tcl
