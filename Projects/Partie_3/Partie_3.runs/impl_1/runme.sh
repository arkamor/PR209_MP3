...
HD_PWD='/home/user/cours/PR209_MP3/Projects/Partie_3/Partie_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Partie3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_Partie3.tcl -notrace
